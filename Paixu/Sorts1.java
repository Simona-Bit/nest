...
public class Sorts1 {
    ...
    private static void mergeSortWithComparator(Person[] array, Comparator<Person> comparator){
    ...
    private static void bubbleSort(Person[] array, Comparator<Person> comparator){
